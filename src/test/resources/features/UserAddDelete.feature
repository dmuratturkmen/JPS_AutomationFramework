...
#  Used background to reduce repetitive test steps
  Background:
    When I navigate to the url
    And I verify url by title

#  Used Scenario outline with examples keyword to increase re-usability in case we need to create more than one user
#  We can also use data table (parameterization) or read data from external sources if necessary.
  @AddUser
...
#    We can also perform delete action using search function, however, in our scenario, user novak
#    remains in the search box after deletion and requires additional steps to verify. But applicable
#    in case we have hundreds of users
  @Delete
